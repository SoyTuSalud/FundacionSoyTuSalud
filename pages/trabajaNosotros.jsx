...
import { CodeServices } from '../graphql-front/servicesCodes/queries'
import { departamentos } from '../utils/deparamentos'
import { municipios } from '../utils/municipios'
import AddBoxIcon from '@mui/icons-material/AddBox'
import { crearServicios } from '../graphql-front/servicios/mutations'
                    ...
                    >
                      <div className="row mt-10">
                        <h6 className="form__title">
                          ...
                          pondremos en contacto con un especialista que te ayude
                          a mejorar tu estado de salud.
                        </h6>
                        <label className="control-label mb-1">
                          Por favor, verifica los campos obligatorios marcados
                          con un (*){' '}
                        </label>
                      </div>
                          ...
                          <div className="contenedor mt-8">
                            ...
                            <div className="">
                              ...
                              <label className="" htmlFor="logo">
                                <button className="bg-blue-600 hover:bg-blue-700 hover:shadow-md text-white mt-2 rounded-md px-12 py-1">
                                  Subir Foto
                                </button>
                              </label>
                              <input
                      ...
                      <div className="row">
                        <div className="col-12 mt-12">
                          <h6 className="form__title">Datos Personales</h6>
                        </div>
                      ...
                      <div>
                        ...
                        <div className=" mt-6 max-w-xs">
                          <div className="">
                            ...
                            <label
                              className="space-x-2"
                              htmlFor="distintivoHabilitacion"
                            >
                              <svg
...
const ListServices = ({ index, handleCheckBox }) => {
  ...
  return (
    <div>
      <div className="row">
        <div className="col-12 mt-12">
          <h6 className="form__title">{`Servicio ${index + 1}`}</h6>
        </div>
      </div>
      <div className="row">
