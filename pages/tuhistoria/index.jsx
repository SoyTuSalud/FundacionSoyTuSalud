...
const Tuhistoria = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    await getDownloadURL(sisbenRef).then((url) => {
      formData.sisben = url
    })
                  ...
                  <div className="col-xl-12">
                    ...
                    >
                      <h6 className="form__title">
                        ...
                        vulnerabilidad, que padece una enfermedad y necesita
                        servicios médicos, diligencia este formulario y te
                        pondremos en contacto con un especialista que te ayude a
                        mejorar su estado de salud.
                      </h6>
                      <label className="control-label mb-1">
                        Por favor, verifique los campos obligatorios marcados
                        con un (*){' '}
                      </label>
                      <div className="row">
                        ...
                        <div className="col-lg-2">
                          ...
                          >
                            ...
                            {departamentos.map((depatamento) => (
                              <option
                                value={depatamento.codigo}
                                key={depatamento.codigo}
                              >
                                {depatamento.nombre}
                              </option>
                            ))}
                      ...
                      <div className="row">
                        ...
                        <div className="col-lg-4">
                          ...
                          >
                            ...
                            <option value="4">
                              Menores desvinculados del conflicto armado, a
                              cargo del ICBF (subsidiado)
                            </option>
                            <option value="5">
                              Población desmovilizada (subsidiado)
                            </option>
                            <option value="6">
                              Víctima del conflicto armado interno ley 1448 de
                              2011
                            </option>
                            <option value="7">
                            ...
                            <option value="17">
                              Personas que dejen de ser madres comunitarias y
                              sean beneficiarias del subsidio de la Subcuenta de
                            ...
                            <option value="21">
                              ...
                              que celebren acuerdos de paz con el Gobierno
                            </option>
                            <option value="22">
                              Migrante Venezolano con PEP e hijos menores de
                              edad con documento válido
                            </option>
                          </select>
                        </div>
                      </div>
                      ...
                      <div className="row">
                        <div className="col-12">
                          ...
                          >
                            <option value="">Seleccionar</option>
                            <option value="1">
                              AXA COLPATRIA SEGUROS S.A. (EN ADELANTE LA
                              SOCIEDAD)
                            </option>
                            ...
                            <option value="10">
                              ASISTENCIA MEDICA INMEDIATA-SERVICIO DE AMBULANCIA
                              PREPAGADA S.A.
                            </option>
                            <option value="11">
                              ASISTENCIA MEDICA SAS SERVICIO DE AMBULANCIA
                              PREPAGADO
                            </option>
                            <option value="12">
                            ...
                            <option value="18">
                              ...
                              NARIÑO - EMSSANAR E.S.S.
                            </option>
                            <option value="19">
                              ASOCIACIÓN MUTUAL EMPRESA SOLIDARIA DE SALUD DE
                              NARIÑO - EMSSANAR E.S.S. -CM
                            </option>
                            <option value="20">
                            ...
                            <option value="24">
                              BBVA SEGUROS COLOMBIA S.A. PUDIENDO UTILIZAR
                              INDISTINTAMENTE, PARA TODOS LOS EFECTOS LEGALES,
                              EL NOMBRE BBVA SEGUROS
                            </option>
                            <option value="25">
                              BERKLEY INTERNATIONAL SEGUROS COLOMBIA S.A. SIGLA
                              BERKLEY COLOMBIA (EN ADELANTE LA SOCIEDAD)
                            </option>
                            ...
                            <option value="31">
                              CAJA DE COMPENSACIÓN FAMILIAR C.C.F. DEL ORIENTE
                              COLOMBIANO - COMFAORIENTE
                            </option>
                            <option value="32">
                              CAJA DE COMPENSACIÓN FAMILIAR C.C.F. DEL ORIENTE
                              COLOMBIANO - COMFAORIENTE -CM
                            </option>
                            <option value="33">
                            ...
                            <option value="54">
                              CAJA DE COMPENSACIÓN FAMILIAR DEL NORTE DE
                              SANTANDER - COMFANORTE
                            </option>
                            <option value="55">
                              CAJA DE PREVISION SOCIAL Y SEGURIDAD DEL CASANARE
                              - CAPRESOCA E.P.S.
                            </option>
                            <option value="56">
                              CAJA DE PREVISION SOCIAL Y SEGURIDAD DEL CASANARE
                            ...
                            <option value="61">
                              COFACE COLOMBIA SEGUROS DE CRÉDITO S.A. (EN
                              ADELANTE: COMPAÑÍA ASEGURADORA
                            </option>
                            <option value="62">
                            ...
                            <option value="70">
                              COMPAÑÍA MUNDIAL DE SEGUROS S.A. SIGLA: MUNDIAL
                              SEGUROS
                            </option>
                            ...
                            <option value="80">
                              ...
                              SUR ORIENTAL DE CARTAGENA - COOSALUD
                            </option>
                            <option value="81">
                              COOPERATIVA DE SALUD Y DESARROLLO INTEGRAL ZONA
                              SUR ORIENTAL DE CARTAGENA - COOSALUD -CM
                            </option>
                            <option value="82">
                              COOPERATIVA DE SALUD Y DESARROLLO INTEGRAL ZONA
                              SUR ORIENTAL DE CARTAGENA LTDA. - COOSALUD E.S.S.
                            </option>
                            <option value="83">
                              COOPERATIVA DE SALUD Y DESARROLLO INTEGRAL ZONA
                              SUR ORIENTAL DE CARTAGENA LTDA. - COOSALUD E.S.S.
                            ...
                            <option value="95">
                              ENTIDAD COOPERATIVA SOLIDARIA DE SALUD DEL NORTE
                              DE SOACHA - ECOOPSOS
                            </option>
                            <option value="96">
                              ENTIDAD COOPERATIVA SOLIDARIA DE SALUD DEL NORTE
                              DE SOACHA - ECOOPSOS -CM
                            </option>
                            ...
                            <option value="100">
                              EPS Y MEDICINA PREPAGADA SURAMERICANA S.A -CM
                            </option>
                            <option value="101">
                              EPS Y MEDICINA PREPAGADA SURAMERICANA S.A.
                            </option>
                            ...
                            <option value="103">
                              FAMISANAR CAFAM_COLSUBSIDIO EPS
                            </option>
                            <option value="104">
                            ...
                            <option value="108">
                              GENERALI COLOMBIA-SEGUROS GENERALES S.A. SIGLA:
                              GENERALI COLOMBIA
                            </option>
                            <option value="109">
                              JMALUCELLITRAVELERS SEGUROS S.A. (EN ADELANTE LA
                              COMPAÑÍA ASEGURADORA O LA SOCIEDAD) SIGLA:
                            ...
                            <option value="111">
                              LIBERTY SEGUROS S.A., PUDIENDO UTILIZAR
                              COMERCIALMENTE LIBERTY SEGUROS O LIBERTY
                            </option>
                            ...
                            <option value="117">
                              MAPFRE SEGUROS GENERALES DE COLOMBIA S.A. SIGLA:
                              MAPFRE SEGUROS
                            </option>
                            ...
                            <option value="124">
                              ...
                              GENERALES - SIGLA: NACIONAL DE SEGUROS
                            </option>
                            ...
                            <option value="134">
                              QBE SEGUROS S.A. PODRÁ USAR LAS SIGLAS QBE
                              COLOMBIA O QBE SEGUROS
                            </option>
                            <option value="135">
                              RED MEDICA MÉDICA VITAL S.A.S. SERVICIO DE
                              AMBULANCIA PREPAGADO (SAP)
                            </option>
                            <option value="136">
                            ...
                            <option value="146">
                              SEGUREXPO DE COLOMBIA S.A. ASEGURADORA DE CRÉDITO
                              Y DEL COMERCIO EXTERIOR. DENOMINACIÓN SIMPLE DE
                              SEGUREXPO
                            </option>
                            ...
                            <option value="150">
                              SERVICIO DE ASISTENCIA MEDICA INMEDIATA S.A. -
                              SERVICIO DE AMBULANCIA PREPAGADO
                            </option>
                            <option value="151">
                              SERVICIO DE EMERGENCIAS REGIONAL (SERVICIO DE
                              AMBULANCIA PREPAGADO) S.A.
                            </option>
                            <option value="152">
                            ...
                            <option value="156">
                              SERVICIOS MEDICOS INTEGRALES DE COLOMBIA SERVICIO
                              DE AMBULANCIAS PREPAGADO S.A.S SEMI SAP S.A.S.
                            </option>
                            <option value="157">
                              SOLUNION COLOMBIA SEGUROS DE CRÉDITO S.A. SIGLA:
                              SOLUNION S.A.
                            </option>
                            <option value="158">
                            ...
                            <option value="169">
                              ZURICH COLOMBIA SEGUROS S.A. (LA SOCIEDAD)
                            </option>
                          </select>
                        </div>
                      </div>
                      ...
                      <div className="row">
                        <div className="col-12">
                          ...
                          <span className="form__text">
                            {' '}
                            <label className="control-label mb-1">
                              Cuéntanos si padeces de alguna enfermedad, si no
                              has tenido acceso a servicios de salud oportunos,
                              actualmente cuentas con tratamiento y todos los
                              detalles que nos permitan saber como Soy Tu puede
                              ayudarte.{' '}
                            </label>{' '}
                          </span>
                        </div>
                      ...
                      <div className="row">
                        ...
                        <div className="col-lg-4">
                          <label className="form__checkbox-label">
                            ...
                            <input
                              ...
                              type="checkbox"
                              onChange={handleCheckBox}
                              value="Consulta Medica Especializada"
                              id="cb2"
                            />
                            <span className="form__checkbox-mask"></span>
                          </label>
                        ...
                        <div className="col-lg-4">
                          <label className="form__checkbox-label">
                            ...
                            <input
                              ...
                              type="checkbox"
                              onChange={handleCheckBox}
                              value="Otros Profesionales de la Salud"
                              id="cb3"
                            />
                            <span className="form__checkbox-mask"></span>
                          </label>
                        ...
                        <div className="col-lg-4">
                          <label className="form__checkbox-label">
                            ...
                            <input
                              ...
                              type="checkbox"
                              onChange={handleCheckBox}
                              value="Exámenes de Laboratorios"
                              id="cb5"
                            />
                            <span className="form__checkbox-mask"></span>
                          </label>
                        ...
                        <div className="col-lg-4">
                          <label className="form__checkbox-label">
                            <span className="form__label-text">Rayos X</span>
                            <input
                              className="form__input-checkbox"
                              type="checkbox"
                              onChange={handleCheckBox}
                        ...
                        <div className="col-lg-4">
                          <label className="form__checkbox-label">
                            <span className="form__label-text">Terapias</span>
                            <input
                              className="form__input-checkbox"
                              type="checkbox"
                              onChange={handleCheckBox}
                        ...
                        <div className="col-lg-4">
                          <label className="form__checkbox-label">
                            ...
                            <input
                              ...
                              type="checkbox"
                              onChange={handleCheckBox}
                              value="Cirugia Ambulatoria Y Otros Servicios"
                              id="cb9"
                            />
                            <span className="form__checkbox-mask"></span>
                          </label>
                      ...
                      <div className="row">
                        <div className="col-12">
                          <label className="form__checkbox-label">
                            ...
                            >
                              {' '}
                              Autorizo de manera voluntaria, mostrar mi nombre y
                              mi foto
                            </span>
                            <input
                              className="form__input-checkbox"
                        ...
                        <div className="col-12">
                          <label className="form__checkbox-label">
                            <span
                              ...
                              value={true}
                            >
                              Autorizo de manera voluntaria, previa, expresa e
                              informada a Soy Tú para la recolección y posterior
                              análisis de los datos aquí suministrados, con la
                              finalidad de ser contactado y atender mis
                              necesidades. Así mismo, declaro que he sido
                              informado sobre el derecho que tengo a conocer,
                              actualizar y rectificar mis datos personales,
                              solicitar prueba de la autorización, ser informado
                              sobre el tratamiento que se ha dado a mis datos
                              personales, presentar quejas ante la
                              Superintendencia de Industria y Comercio (SIC),
                              revocar la autorización otorgada y/o solicitar la
                              supresión de mis datos en los casos en que sea
                              procedente
                            </span>
                            <input
                              className="form__input-checkbox"
