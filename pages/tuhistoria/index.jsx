            ...
            >
              ...
              <div className="container-label-input-eps">
                ...
                >
                  <option value="">Seleccionar</option>
                  <option value="1">
                    AXA COLPATRIA SEGUROS S.A. (EN ADELANTE LA SOCIEDAD)
                  </option>
                  ...
                  <option value="10">
                    ASISTENCIA MEDICA INMEDIATA-SERVICIO DE AMBULANCIA PREPAGADA
                    S.A.
                  </option>
                  <option value="11">
                  ...
                  <option value="23">
                    ASOCIACIÓN MUTUAL SER EMPRESA SOLIDARIA DE SALUD E.S.S. -CM
                  </option>
                  <option value="24">
                    BBVA SEGUROS COLOMBIA S.A. PUDIENDO UTILIZAR
                    INDISTINTAMENTE, PARA TODOS LOS EFECTOS LEGALES, EL NOMBRE
                    BBVA SEGUROS
                  </option>
                  <option value="25">
                    BERKLEY INTERNATIONAL SEGUROS COLOMBIA S.A. SIGLA BERKLEY
                  ...
                  <option value="34">
                    CAJA DE COMPENSACION FAMILIAR CAJACOPI ATLANTICO -CM
                  </option>
                  <option value="35">
                    CAJA DE COMPENSACIÓN FAMILIAR DE BOYACÁ - COMFABOY
                  </option>
                  <option value="36">
                    CAJA DE COMPENSACIÓN FAMILIAR DE BOYACÁ - COMFABOY -CM
                  </option>
                  <option value="37">
                  ...
                  <option value="40">
                    CAJA DE COMPENSACION FAMILIAR DE CORDOBA - COMFACOR -CM
                  </option>
                  <option value="41">
                  ...
                  <option value="49">
                    CAJA DE COMPENSACIÓN FAMILIAR DE SUCRE - COMFASUCRE -CM
                  </option>
                  <option value="50">
                    CAJA DE COMPENSACIÓN FAMILIAR DEL CHOCÓ - COMFACHOCO
                  </option>
                  <option value="51">
                  ...
                  <option value="61">
                    COFACE COLOMBIA SEGUROS DE CRÉDITO S.A. (EN ADELANTE:
                  ...
                  <option value="67">
                    COMPAÑÍA ASEGURADORA DE FIANZAS S.A., CONFIANZA SIGLA:
                    CONFIANZA S.A.
                  </option>
                  <option value="68">
                  ...
                  <option value="70">
                    COMPAÑÍA MUNDIAL DE SEGUROS S.A. SIGLA: MUNDIAL SEGUROS
                  </option>
                  ...
                  <option value="80">
                    ...
                    DE CARTAGENA - COOSALUD
                  </option>
                  <option value="81">
                    COOPERATIVA DE SALUD Y DESARROLLO INTEGRAL ZONA SUR ORIENTAL
                    DE CARTAGENA - COOSALUD -CM
                  </option>
                  <option value="82">
                    COOPERATIVA DE SALUD Y DESARROLLO INTEGRAL ZONA SUR ORIENTAL
                    DE CARTAGENA LTDA. - COOSALUD E.S.S.
                  </option>
                  <option value="83">
                    COOPERATIVA DE SALUD Y DESARROLLO INTEGRAL ZONA SUR ORIENTAL
                    DE CARTAGENA LTDA. - COOSALUD E.S.S. -CM
                  </option>
                  ...
                  <option value="91">
                    EMPRESA DE MEDICINA INTEGRAL EMI SA SERVICIO DE AMBULANCIA
                    PREPAGADA
                  </option>
                  <option value="92">
                  ...
                  <option value="95">
                    ENTIDAD COOPERATIVA SOLIDARIA DE SALUD DEL NORTE DE SOACHA -
                    ECOOPSOS
                  </option>
                  <option value="96">
                    ENTIDAD COOPERATIVA SOLIDARIA DE SALUD DEL NORTE DE SOACHA -
                  ...
                  <option value="108">
                    GENERALI COLOMBIA-SEGUROS GENERALES S.A. SIGLA: GENERALI
                    COLOMBIA
                  </option>
                  <option value="109">
                    JMALUCELLITRAVELERS SEGUROS S.A. (EN ADELANTE LA COMPAÑÍA
                    ASEGURADORA O LA SOCIEDAD) SIGLA: JMALUCELLITRAVELERS
                    SEGUROS S.A.
                  </option>
                  <option value="110">
                  ...
                  <option value="111">
                    LIBERTY SEGUROS S.A., PUDIENDO UTILIZAR COMERCIALMENTE
                    LIBERTY SEGUROS O LIBERTY
                  </option>
                  ...
                  <option value="117">
                    MAPFRE SEGUROS GENERALES DE COLOMBIA S.A. SIGLA: MAPFRE
                    SEGUROS
                  </option>
                  ...
                  <option value="134">
                    QBE SEGUROS S.A. PODRÁ USAR LAS SIGLAS QBE COLOMBIA O QBE
                    SEGUROS
                  </option>
                  <option value="135">
                    RED MEDICA MÉDICA VITAL S.A.S. SERVICIO DE AMBULANCIA
                    PREPAGADO (SAP)
                  </option>
                  <option value="136">
                    ROYAL & SUN ALLIANCE SEGUROS (COLOMBIA) S.A. ABREVIATURA:
                    RSA
                  </option>
                  ...
                  <option value="146">
                    SEGUREXPO DE COLOMBIA S.A. ASEGURADORA DE CRÉDITO Y DEL
                    COMERCIO EXTERIOR. DENOMINACIÓN SIMPLE DE SEGUREXPO
                  </option>
                  ...
                  <option value="150">
                    SERVICIO DE ASISTENCIA MEDICA INMEDIATA S.A. - SERVICIO DE
                    AMBULANCIA PREPAGADO
                  </option>
                  <option value="151">
                    SERVICIO DE EMERGENCIAS REGIONAL (SERVICIO DE AMBULANCIA
                    PREPAGADO) S.A.
                  </option>
                  <option value="152">
                  ...
                  <option value="156">
                    SERVICIOS MEDICOS INTEGRALES DE COLOMBIA SERVICIO DE
                    AMBULANCIAS PREPAGADO S.A.S SEMI SAP S.A.S.
                  </option>
                  <option value="157">
                    SOLUNION COLOMBIA SEGUROS DE CRÉDITO S.A. SIGLA: SOLUNION
                    S.A.
                  </option>
              ...
              <span className="form__text">
                {' '}
                <label className="control-label mb-1">
                  Cuéntanos si padeces de alguna enfermedad, si no has tenido
                  acceso a servicios de salud oportunos, actualmente cuentas con
                  tratamiento y todos los detalles que nos permitan saber como
                  Soy Tu puede ayudarte.{' '}
                </label>{' '}
              </span>

              <div className="servicio-solicitado-container">
                <h6 className="general-titles">Servicio Solicitado</h6>
                <div className="container-checkboxs">
                  <div className="container-checkbox-3">
                    <div className="">
                    ...
                    <div className="">
                      <label className="form__checkbox-label">
                        <input
                          ...
                          id="cb4"
                        />
                        <span className="label-checkbox">Medicamento</span>
                        <span className="form__checkbox-mask"></span>
                      </label>
                    </div>
                    <div className="">
                    ...
                    <div className="">
                      <label className="form__checkbox-label">
                        <input
                          ...
                          id="cb6"
                        />
                        <span className="label-checkbox">Rayos X</span>
                        <span className="form__checkbox-mask"></span>
                      </label>
                    </div>
                  </div>
                    ...
                    <div className="">
                      <label className="form__checkbox-label">
                        <input
                          ...
                          id="cb8"
                        />
                        <span className="label-checkbox">Terapias</span>
                        <span className="form__checkbox-mask"></span>
                      </label>
                    </div>
                    <div className="">
                ...
                <div className="col-12">
                  <label className="form__checkbox-label">
                    ...
                    >
                      ...
                      a Soy Tú para la recolección y posterior análisis de los
                      datos aquí suministrados, con la finalidad de ser
                      contactado y atender mis necesidades. Así mismo, declaro
                      que he sido informado sobre el derecho que tengo a
                      conocer, actualizar y rectificar mis datos personales,
                      solicitar prueba de la autorización, ser informado sobre
                      el tratamiento que se ha dado a mis datos personales,
                      presentar quejas ante la Superintendencia de Industria y
                      Comercio (SIC), revocar la autorización otorgada y/o
