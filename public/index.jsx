                ...
                <div className="align-container">
                  <div className="align-container__item">
                    <h1 className="promo-primary__title pt-2 mb-4">
                      <span className="" data-lang="eslogan1">
                        Mejoramos la Salud de personas en situación de
                        vulnerabilidad{' '}
                      </span>
                      <span data-lang="eslogan2">
                        con recursos de Responsabilidad Social
                      </span>
                    </h1>
                  </div>
                </div>
          ...
          <div className="container mt-6">
            <div className="row align-items-center">
              <div className="col-lg-6">
                ...
                <p>
                  Conoces a algún familiar, amigo, persona o tú que necesite
                  algún servicio médico y se encuentre en situación de
                  vulnerabilidad? En www.soytusalud.org informa tu historia o su
                  historia, aplica y Listo!!.
                </p>
                <p>
                  {' '}
                  En la Fundación <a href="">www.soytusalud.org</a> una vez has
                  demostrado que estás en una situación de vulnerabilidad,
                  podrás acceder :
                </p>
                <div className="row">
                  <div className="col-md-6 col-lg-12">
                    <ul className="unordered-list">
                      ...
                      <li>
                        Otros servicios para su salud, que estén disponibles.
                      </li>
                    </ul>
                  </div>
                </div>
                ...
                <div className="icon-item">
                  <div className="icon-item__img">
                    <div className="icon icon-item__icon icon--red">
                      <Image
                        src="../assets/images/Logo_servicios1.png"
                        alt="img"
                      />
                    </div>
