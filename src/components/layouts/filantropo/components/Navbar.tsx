...
const Navbar = () => {
  return (
    <div style={{backgroundColor: "#616AC5"}}>
        ...
        <div className="w-full  flex py-3 max-w-screen-2xl justify-between items-center">
          <div className="flex items-center space-x-10  ">
            <Image
              ...
              quality={100}
            />
            <span className="text-white back px-8 rounded-xl font-semibold " style={{backgroundColor: "#E26D83"}} >Filántropo</span>
          </div>
          <div className="flex space-x-9">
            ...
            <ul>
              <li className="text-white font-semibold">Proyectos de Maternidad</li>
            </ul>
            <ul>
