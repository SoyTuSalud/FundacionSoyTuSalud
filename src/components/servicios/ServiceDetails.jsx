        ...
        <CardContent>
          <Grid container spacing={3}>
            <Grid item md={3} xs={12}>
              ...
              <Grid>
                <Typography variant="outlined">{servicio.celular}</Typography>
              </Grid>
            </Grid>
            <Grid item md={3} xs={12}>
              <Typography variant="outlined" fontWeight={'bold'}>
                ...
                <Typography variant="outlined">
                  {
                    departamentos.filter(
                      (dpto) => dpto.codigo === servicio.departamento,
                    )[0].nombre
                  }
                </Typography>
              </Grid>
            ...
            <Grid item md={3} xs={12}>
              ...
              <Grid>
                <Typography variant="outlined">{servicio.municipio}</Typography>
              </Grid>
            </Grid>
            <Grid item md={3} xs={12}>
              <Typography variant="outlined" fontWeight={'bold'}>
              ...
              <Grid>
                <Typography variant="outlined">{servicio.direccion}</Typography>
              </Grid>
            </Grid>
            <Grid item md={3} xs={12}>
              <Typography variant="outlined" fontWeight={'bold'}>
              ...
              <Grid>
                <Typography variant="outlined">
                  <a
                    ...
                    target="_blank"
                    href={servicio.distintivoHabilitacion}
                    rel="noreferrer"
                  >
                    Ver Distintivo
                  </a>
              ...
              <Grid>
                <Typography variant="outlined">
                  <a
                    className="text-blue-500"
                    target="_blank"
                    href={servicio.fotoLogoPublicidad}
                    rel="noreferrer"
                  >
                    Ver foto
                  </a>
              ...
              <Grid>
                <Typography variant="outlined">
                  <a
                    className="text-blue-500"
                    target="_blank"
                    href={servicio.convalidacionIcfes}
                    rel="noreferrer"
                  >
                    Ver Certificado
                  </a>
              ...
              <Grid>
                <FormControlLabel
                  control={
                    <IOSSwitch
                      sx={{ m: 1 }}
                      onChange={(e) => handleState(e, servicio.identificacion)}
                      defaultChecked={servicio.habilitado}
                    />
                  }
                />
              </Grid>
