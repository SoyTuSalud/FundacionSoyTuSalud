        ...
        >
          ...
          <div className="p-3 pt-1 block">
            ...
            <ul className="flex flex-col">
              ...
              <li className="flex justify-between"><span>Haz ayudado con:</span>$300.000</li>
        ...
        <div className="flex flex-col items-center px-6">
          <div className="flex flex-col items-center space-y-3">
            <div className="text-2xl text-black">
              <span className="inline-flex items-center justify-center font-black text-white p-6 rounded-full w-9 h-9 mr-3" 
            ...
            <p className="mt-1 text-center">Sed ud perspiciatis unde omnis ise natus error sit voluptatem accusantium</p>
            ...
            >
              <div className="px-6 py-3 flex flex-col justify-center items-center text-black">
                ...
                <div className="my-3 space-y-2">
                  ...
                  <p className="text-gray-500">Sed ud perspiciatis unde omnis ise natus error sit voluptatem accusantium</p>
