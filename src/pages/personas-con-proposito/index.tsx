              ...
              <div className="col-12">
                <div className="heading heading--primary heading--center">
                  <h2 className="heading__title no-margin-bottom">
                    <span>Personas Con Propósito Filantrópicos</span>
                  </h2>
                </div>
              </div>
            </div>
...
PersonasProposito.getLayout = function getLayout(page:ReactElement , props: any) {
...
export default PersonasProposito
