                      ...
                      <div className="col-lg-7 col-xl-8">
                        ...
                        <div className="causes-item__top">
                          <h6 className="causes-item__title">
                            {' '}
                            <a href="src/pages2/donaciones#">Paciente de prueba numero 1</a>
                          </h6>
                    ...
                    <div className="row align-items-center">
                      ...
                      <div className="col-lg-7 col-xl-8">
                        ...
                        <div className="causes-item__top">
                          <h6 className="causes-item__title">
                            {' '}
                            <a href="src/pages2/donaciones#">Paciente de prueba numero 2</a>
                          </h6>
                          <p>esta es una historia de prueba </p>
                        </div>
                        <div className="causes-item__lower">
...
Donaciones.getLayout = function getLayout(page:ReactElement , props: any) {
