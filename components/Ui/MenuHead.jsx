...
export const MenuHead = () => {
  ...
  return (
    <>
      ...
      <link
        href="https://fonts.googleapis.com/css2?family=Quicksand:wght@319;400;600;700&display=swap"
        rel="stylesheet"
      ></link>
          ...
          <div className="row no-gutters justify-content-between">
            ...
            <div className="col-auto d-flex align-items-center">
              <ul className="lang-select lang-select--inner">
                <li className="lang-select__item lang-select__item--active">
                  <span data-lang="idioma">Es</span>
                  <ul className="lang-select__sub-list">
                    <li>
                      <a
                        href="#"
                        id="translate"
                        data-text="English,Espa&ntilde;ol"
                        data-file="es,en"
                        data-index="1"
                      >
                        English
