            ...
            <ul className="footer-socials">
              <li className="footer-socials__item">
                <a
                  ...
                  href="https://www.facebook.com/Fundación-Soy-Tú-Salud-107327561900263"
                  target="_blank"
                  rel="noreferrer"
                >
              ...
              <li className="footer-socials__item">
                <a
                  className="footer-socials__link"
                  href="https://www.linkedin.com/in/fundación-soy-tú-salud-845592233/"
                  target="_blank"
                  rel="noreferrer"
                >
              ...
              <li className="footer-socials__item">
                <a
                  className="footer-socials__link"
                  href="https://twitter.com/FundacinSoyTSa1"
                  target="_blank"
                  rel="noreferrer"
                >
              ...
              <li className="footer-socials__item">
                <a
                  className="footer-socials__link"
                  href="https://www.instagram.com/fundacionsoytusalud/"
                  target="_blank"
                  rel="noreferrer"
                >
          ...
          <div className="col-sm-6 col-lg-3">
            ...
            <div className="footer-contacts">
              ...
              <p className="footer-contacts__phone">
                Telefono: <a href="tel:+3207148401">+57 320 702 3823</a>
              </p>
              <p className="footer-contacts__mail">
                Email: <a href="mailto:soutu@soutu.org">info@soytusalud.org</a>
              </p>
            </div>
          </div>
        ...
        <div className="row align-items-baseline">
          <div className="col-md-6">
            <p className="footer-copyright">
              Copyright © 2022 Soy Tú Salud. Todos los derechos reservados.
            </p>
          </div>
        </div>
      </div>
