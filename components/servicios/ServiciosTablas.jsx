...
export const ServiciosTablas = ({ serviciosData, ...rest }) => {
  ...
  const handleSelectAll = (event) => {
    ...
    if (event.target.checked) {
      newSelectedCustomerIds = serviciosData.map(
        ...
        <Table>
          <TableHead>
            <TableRow>
              ...
              <TableCell>Servicios Principales</TableCell>
              ...
              >
                <TableCell padding="checkbox">
                  <Checkbox
                    ...
                    onChange={(event) =>
                      handleSelectOne(event, service.identificacion)
                    }
                    value="true"
                  />
                </TableCell>
                <TableCell>
                  ...
                  >
                    <Avatar src={service.foto} sx={{ mr: 2 }}>
                ...
                <TableCell>
                  {
                    departamentos.filter(
                      (dpto) => dpto.codigo === service.departamento,
                    )[0].nombre
                  }
                </TableCell>
                <TableCell>{service.municipio}</TableCell>
                <TableCell>{service.direccion}</TableCell>
                <TableCell>
                  {service.servicios.map(
